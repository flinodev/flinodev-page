...
Siguiendo la página de <a href="https://attack.mitre.org/techniques/T1566/" target="_blank">attack.mitre.org para la técnica Phising</a> encontramos que el ID es el T1566
...
En la misma <a href="https://attack.mitre.org/techniques/T1566/" target="_blank">página para la técnica Phising</a> en la sección __Mitigations__ encontramos la respuesta a esta pregunta
...
En la misma <a href="https://attack.mitre.org/techniques/T1566/" target="_blank">página para la técnica Phising</a> en la sección __Detection__ encontramos la respuesta a esta pregunta
...
En la misma <a href="https://attack.mitre.org/techniques/T1566/" target="_blank">página para la técnica Phising</a> en la sección __Procedure Examples__ encontramos la respuesta a esta pregunta
...
En la <a href="https://attack.mitre.org/groups/G0001/" target="_blank">página del grupo Axiom</a> en la sección __Associated Group Descriptions__ encontramos la respuesta a esta pregunta
...
En la <a href="https://attack.mitre.org/groups/G0001/" target="_blank">página del grupo Axiom</a> en la sección __Software__ encontramos la respuesta a esta pregunta
...
En la <a href="https://attack.mitre.org/software/S0009/" target="_blank">página del software Hikit</a> encontramos la respuesta a esta pregunta
...
En la <a href="https://attack.mitre.org/groups/G0001/" target="_blank">página del grupo Axiom</a>   encontramos la respuesta a esta pregunta
...
En la <a href="https://attack.mitre.org/software/S0009/" target="_blank">página del software Hikit</a> en la sección __Techniques Used__ encontramos la respuesta a esta pregunta
...
Revisando en primer instancia la <a href="https://car.mitre.org/analytics/CAR-2020-09-001/" target="_blank">página de CAR-2020-09-001: Scheduled Task - FileAccess</a> en la sección **Tactics** encontramos 4 tácticas (Execution, Persistence, Privilege Escalation). Explorando una por una, encontramos que la táctica con el ID **TA0003** es <a href="https://attack.mitre.org/tactics/TA0003/" target="_blank">Persistence</a>
...
En la <a href="https://car.mitre.org/" target="_blank">página principal</a> en la sección __Analytic Source Code Libraries__ encontramos la respuesta a esta pregunta.
...
En la <a href="https://car.mitre.org/analytics/" target="_blank">lista analítica</a> buscamos el término __"hash"__  y podremos encontrar la respuesta a esta pregunta.
...
En la página del <a href="https://car.mitre.org/analytics/CAR-2013-05-004/" target="_blank">CAR-2013-05-004</a> en la última sección encontramos respuesta a esta pregunta.
...
En la página <a href="https://engage.mitre.org/matrix/?activity=persona-creation" target="_blank">MITRE Engage</a> en la sección __Prepare__ encontramos respuesta a esta pregunta.
...
En las <a href="https://engage.mitre.org/tools/" target="_blank">herramientas</a> buscamos el término "**persona**" y podremos encontrar la respuesta a esta pregunta.
...
Revisando el <a href="https://engage.mitre.org/wp-content/uploads/2022/04/EngageHandbook-v1.0.pdf" target="_blank">Engage Handbook</a> en la página 21, sección 3.3.4 encontramos la respuesta
...
En la página <a href="https://d3fend.mitre.org/" target="_blank">D3fend MITRE</a> al hacer click en __ATT&CK Lookup__ encontramos la respuesta a la pregunta.
...
En el diagrama de la página <a href="https://d3fend.mitre.org/offensive-technique/attack/T1001.003/" target="_blank">Protocol or Service Impersonation - T1001.003</a> encontramos la respuesta.
...
En la página <a href="https://attack.mitre.org/resources/adversary-emulation-plans/" target="_blank">Adversary Emulation Plans</a> en el diagrama __APT 3 Emulation Plan__ encontramos la respuesta a esta pregunta
...
En la página 24 sección __3.2.1.3 Persistence__ del manual <a href="https://attack.mitre.org/docs/APT3_Adversary_Emulation_Plan.pdf" target="_blank">APT3_Adversary_Emulation_Plan</a> encontramos la respuesta a esta pregunta
...
En la página <a href="https://github.com/center-for-threat-informed-defense/adversary_emulation_library/blob/master/apt29/Emulation_Plan/Scenario_1/Infrastructure.md#emulation-team-infrastructure" target="_blank">APT29 Emulation Plan Scenario 1</a> en la sección __Emulation Team Infrastructure__ encontramos la respuesta a esta pregunta
...
En la página <a href="https://github.com/center-for-threat-informed-defense/adversary_emulation_library/blob/master/apt29/Emulation_Plan/Scenario_2/Infrastructure.md#emulation-team-infrastructure" target="_blank">APT29 Emulation Plan Scenario 2</a> en la sección __Emulation Team Infrastructure__ encontramos la respuesta a esta pregunta
...
En la página <a href="https://attack.mitre.org/groups/" target="_blank">MITRE ACC&CK Groups</a> encontramos la respuesta a la pregunta.
...
Examinando las técnicas usadas por este grupo <a href="https://attack.mitre.org/groups/G0064/" target="_blank">G0064</a> encontramos la respuesta a la pregunta.
...
En la técnica __Cloud Accounts__ usadas por este grupo <a href="https://attack.mitre.org/groups/G0064/" target="_blank">G0064</a>  encontramos la respuesta a la pregunta.
...
En la técnica <a href="https://attack.mitre.org/techniques/T1078/004/" target="_blank">Cloud Accounts</a>  en la sección __Mitigations__ encontramos la respuesta a esta pregunta
...
En la técnica <a href="https://attack.mitre.org/techniques/T1078/004/" target="_blank">Cloud Accounts</a>  en la sección principal encontramos la respuesta a esta pregunta
